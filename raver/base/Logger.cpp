...
void Logger::setLevel(Logger::LogLevel level) { g_loglevel = level; }

void Logger::setOutputCallback(OutputCallback cb) { output_callback_ = cb; }

std::stringstream& Logger::stream() { return sstream_; }
